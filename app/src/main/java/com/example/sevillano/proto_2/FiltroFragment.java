...
/**
 * Created by Sevi on 29/09/17.
 */

public class FiltroFragment extends Fragment{

    private FiltroFragment.OnFragmentInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof FiltroFragment.OnFragmentInteractionListener) {
            mListener = (FiltroFragment.OnFragmentInteractionListener) context;
        } else {
